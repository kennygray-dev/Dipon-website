                  ...
                  <div className="relative z-10 mt-auto flex flex-col gap-2 p-3 sm:gap-3 sm:p-4">
                    ...
                    <div className="grid grid-rows-[1fr] transition-[grid-template-rows] duration-400 ease-[var(--ease-premium)] lg:grid-rows-[0fr] lg:group-hover:grid-rows-[1fr]">
                      <div className="overflow-hidden">
                        ...
                        <span className="relative z-20 mt-2.5 inline-flex w-fit items-center gap-2 rounded-full border border-dipon-accent bg-dipon-accent px-3.5 py-1.5 font-label text-[10px] font-semibold text-white shadow-[0_2px_10px_rgba(253,128,46,0.35)] transition-colors duration-200 group-hover:bg-dipon-accent-deep group-hover:border-dipon-accent-deep sm:text-[11px]">
